...
public class TokenComponent {
	...
	public String createJWT(String id) {
		...
		JwtBuilder builder = Jwts.builder()
				.setId(id.toString())
				.setIssuedAt(now)
//				.setSubject(SecurityUtils.getSubject().getSession().getHost())
	 ...
	 */
	public String parseJWT(String jwt, String remoteIp) {
...
//		if(!claims.getSubject().equals(remoteIp)) {
//			throw new SignatureException("请求IP与签名IP不符，鉴权失败。");
//		}
