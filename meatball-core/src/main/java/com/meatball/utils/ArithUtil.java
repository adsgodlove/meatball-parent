...
public class ArithUtil {
	...
	* @throws
	...
	public static float addByFloat(float v1, float v2) {
		...
		return roundFloat(b1.add(b2).floatValue(), DEF_DIV_SCALE);
	}
	...
	* @throws
	...
	public static float subByFloat(float v1, float v2) {
		BigDecimal b1 = new BigDecimal(Float.toString(v1));
		BigDecimal b2 = new BigDecimal(Float.toString(v2));
		return roundFloat(b1.subtract(b2).floatValue(),DEF_DIV_SCALE);
	}
	...
	* @throws
	...
	public static float mulByFloat(float v1, float v2) {
		BigDecimal b1 = new BigDecimal(Float.toString(v1));
		BigDecimal b2 = new BigDecimal(Float.toString(v2));
		return roundFloat(b1.multiply(b2).floatValue(), DEF_DIV_SCALE);
	}
	...
	* @throws
	...
	public static float divByFloat(float v1, float v2) {
		return divByFloat(v1, v2, DEF_DIV_SCALE);
	}
	...
	public static float divByFloat(float v1, float v2, int scale) {
		...
		BigDecimal b1 = new BigDecimal(Float.toString(v1));
		BigDecimal b2 = new BigDecimal(Float.toString(v2));
		return roundFloat(b1.divide(b2, scale, BigDecimal.ROUND_HALF_UP).floatValue(),DEF_DIV_SCALE);
	}
